$(document).ready(function(){
    ...
    $(".ld-left-tit").eq(3).addClass('ld-left-tit4');
    $(".ld-left-tit").eq(4).addClass('ld-left-tit5');
    $(".ld-left-tit").eq(5).addClass('ld-left-tit6');
    ...
    $(".ld-bm-top").find(".ld-blueball").eq(2).find(".ld-blue-num").find("span").html(100-science_bili3);
    $(".ld-bm-top").find(".ld-blueball").eq(2).find(".ld-wave").css({top:-(1-science_bili3/100)*200});
    ...
    //篮球第三块倒计时显示
    var lyn_time3=$(".ld-baoming-con").find(".ld-daojishi").eq(2);
